...
function processMessage(msgLocation, callback) {
  try {
    ...
    if(minifiedContent && typeof minifiedContent !== 'string' && minifiedContent.error) {
      throw {
        message: 'Invalid Uglify configuration passed, Please check https://github.com/mishoo/UglifyJS2 for valid configurations',
        error: minifiedContent
      };
    }
